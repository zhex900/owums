...
ActiveRecord::Schema.define(:version => 20140908144456) do
  ...
  add_index "invoices", ["user_id"], :name => "index_invoices_on_user_id", :unique => true
  ...
  add_index "radacct", ["CalledStationId"], :name => "index_radacct_on_CalledStationId"
  add_index "radacct", ["UserName"], :name => "index_radacct_on_UserName"

  create_table "radcheck", :id => false, :force => true do |t|
    t.string "id",        :limit => 22, :default => "", :null => false
  ...
  create_table "radius_checks", :force => true do |t|
    t.string   "check_attribute",                      :null => false
    t.string   "op",                 :default => ":=", :null => false
    t.string   "value",                                :null => false
  ...
  create_table "radius_replies", :force => true do |t|
    t.string   "reply_attribute",    :null => false
    t.string   "op",                 :null => false
    t.string   "value",              :null => false
    t.integer  "radius_entity_id"
    t.string   "radius_entity_type"
  ...
  add_index "users", ["given_name"], :name => "index_users_on_given_name"
  ...
  add_index "users", ["verification_method"], :name => "index_users_on_verification_method"
  add_index "users", ["verified"], :name => "index_users_on_verified"
  add_index "users", ["verified_at"], :name => "index_users_on_verified_at"
